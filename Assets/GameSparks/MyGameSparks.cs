...
namespace GameSparks.Api.Requests{
	...
	public class LogEventRequest_InputScore : GSTypedRequest<LogEventRequest_InputScore, LogEventResponse>
	{
		...
		public LogEventRequest_InputScore Set_division( string value )
		{
			request.AddString("division", value);
			return this;
		}
	...
	public class LogChallengeEventRequest_InputScore : GSTypedRequest<LogChallengeEventRequest_InputScore, LogChallengeEventResponse>
	{
		...
		public LogChallengeEventRequest_InputScore Set_division( string value )
		{
			request.AddString("division", value);
			return this;
		}
	...
	public class LogEventRequest_loadimageurl : GSTypedRequest<LogEventRequest_loadimageurl, LogEventResponse>
	{
		...
		public LogEventRequest_loadimageurl() : base("LogEventRequest"){
			request.AddString("eventKey", "loadimageurl");
		}
		
		public LogEventRequest_loadimageurl Set_id( string value )
		{
			request.AddString("id", value);
			return this;
		}
		
		public LogEventRequest_loadimageurl Set_url( string value )
		{
			request.AddString("url", value);
			return this;
		}
	...
	public class LogChallengeEventRequest_loadimageurl : GSTypedRequest<LogChallengeEventRequest_loadimageurl, LogChallengeEventResponse>
	{
		public LogChallengeEventRequest_loadimageurl() : base("LogChallengeEventRequest"){
			request.AddString("eventKey", "loadimageurl");
		}
		...
		/// The challenge ID instance to target
		/// </summary>
		public LogChallengeEventRequest_loadimageurl SetChallengeInstanceId( String challengeInstanceId )
		{
			request.AddString("challengeInstanceId", challengeInstanceId);
			return this;
		}
		public LogChallengeEventRequest_loadimageurl Set_id( string value )
		{
			request.AddString("id", value);
			return this;
		}
		public LogChallengeEventRequest_loadimageurl Set_url( string value )
		{
			request.AddString("url", value);
			return this;
		}
...
namespace GameSparks.Api.Responses{
	...
	public class _LeaderboardEntry_Fields : LeaderboardDataResponse._LeaderboardData{
		...
		public string division{
			get{return response.GetString("division");}
		}
...
namespace GameSparks.Api.Requests{
	...
	public class LeaderboardDataRequest_imagedata : GSTypedRequest<LeaderboardDataRequest_imagedata,LeaderboardDataResponse_imagedata>
	{
		public LeaderboardDataRequest_imagedata() : base("LeaderboardDataRequest"){
			request.AddString("leaderboardShortCode", "imagedata");
		}
		
		protected override GSTypedResponse BuildResponse (GSObject response){
			return new LeaderboardDataResponse_imagedata (response);
		}		
		
		/// <summary>
		/// The challenge instance to get the leaderboard data for
		/// </summary>
		public LeaderboardDataRequest_imagedata SetChallengeInstanceId( String challengeInstanceId )
		{
			request.AddString("challengeInstanceId", challengeInstanceId);
			return this;
		}
		...
		/// The number of items to return in a page (default=50)
		/// </summary>
		public LeaderboardDataRequest_imagedata SetEntryCount( long entryCount )
		{
			request.AddNumber("entryCount", entryCount);
			return this;
		}
		...
		/// A friend id or an array of friend ids to use instead of the player's social friends
		/// </summary>
		public LeaderboardDataRequest_imagedata SetFriendIds( List<string> friendIds )
		{
			request.AddStringList("friendIds", friendIds);
			return this;
		}
		...
		/// Number of entries to include from head of the list
		/// </summary>
		public LeaderboardDataRequest_imagedata SetIncludeFirst( long includeFirst )
		{
			request.AddNumber("includeFirst", includeFirst);
			return this;
		}
		...
		/// Number of entries to include from tail of the list
		/// </summary>
		public LeaderboardDataRequest_imagedata SetIncludeLast( long includeLast )
		{
			request.AddNumber("includeLast", includeLast);
			return this;
		}
		...
		/// The offset into the set of leaderboards returned
		/// </summary>
		public LeaderboardDataRequest_imagedata SetOffset( long offset )
		{
			request.AddNumber("offset", offset);
			return this;
		}
		...
		/// If True returns a leaderboard of the player's social friends
		/// </summary>
		public LeaderboardDataRequest_imagedata SetSocial( bool social )
		{
			request.AddBoolean("social", social);
			return this;
		}
		...
		/// The IDs of the teams you are interested in
		/// </summary>
		public LeaderboardDataRequest_imagedata SetTeamIds( List<string> teamIds )
		{
			request.AddStringList("teamIds", teamIds);
			return this;
		}
		...
		/// The type of team you are interested in
		/// </summary>
		public LeaderboardDataRequest_imagedata SetTeamTypes( List<string> teamTypes )
		{
			request.AddStringList("teamTypes", teamTypes);
			return this;
		}
	...
	public class AroundMeLeaderboardRequest_imagedata : GSTypedRequest<AroundMeLeaderboardRequest_imagedata,AroundMeLeaderboardResponse_imagedata>
	{
		public AroundMeLeaderboardRequest_imagedata() : base("AroundMeLeaderboardRequest"){
			request.AddString("leaderboardShortCode", "imagedata");
		}
		
		protected override GSTypedResponse BuildResponse (GSObject response){
			return new AroundMeLeaderboardResponse_imagedata (response);
		}		
		
		/// <summary>
		/// The number of items to return in a page (default=50)
		/// </summary>
		public AroundMeLeaderboardRequest_imagedata SetEntryCount( long entryCount )
		{
			request.AddNumber("entryCount", entryCount);
			return this;
		}
		...
		/// A friend id or an array of friend ids to use instead of the player's social friends
		/// </summary>
		public AroundMeLeaderboardRequest_imagedata SetFriendIds( List<string> friendIds )
		{
			request.AddStringList("friendIds", friendIds);
			return this;
		}
		...
		/// Number of entries to include from head of the list
		/// </summary>
		public AroundMeLeaderboardRequest_imagedata SetIncludeFirst( long includeFirst )
		{
			request.AddNumber("includeFirst", includeFirst);
			return this;
		}
		...
		/// Number of entries to include from tail of the list
		/// </summary>
		public AroundMeLeaderboardRequest_imagedata SetIncludeLast( long includeLast )
		{
			request.AddNumber("includeLast", includeLast);
			return this;
		}
		...
		/// If True returns a leaderboard of the player's social friends
		/// </summary>
		public AroundMeLeaderboardRequest_imagedata SetSocial( bool social )
		{
			request.AddBoolean("social", social);
			return this;
		}
		...
		/// The IDs of the teams you are interested in
		/// </summary>
		public AroundMeLeaderboardRequest_imagedata SetTeamIds( List<string> teamIds )
		{
			request.AddStringList("teamIds", teamIds);
			return this;
		}
		...
		/// The type of team you are interested in
		/// </summary>
		public AroundMeLeaderboardRequest_imagedata SetTeamTypes( List<string> teamTypes )
		{
			request.AddStringList("teamTypes", teamTypes);
			return this;
		}
...
namespace GameSparks.Api.Responses{
	...
	public class _LeaderboardEntry_imagedata : LeaderboardDataResponse._LeaderboardData{
		public _LeaderboardEntry_imagedata(GSData data) : base(data){}
		public string id{
			get{return response.GetString("id");}
		}
		public string url{
	...
	public class LeaderboardDataResponse_imagedata : LeaderboardDataResponse
	{
		public LeaderboardDataResponse_imagedata(GSData data) : base(data){}
		
		public GSEnumerable<_LeaderboardEntry_imagedata> Data_imagedata{
			get{return new GSEnumerable<_LeaderboardEntry_imagedata>(response.GetObjectList("data"), (data) => { return new _LeaderboardEntry_imagedata(data);});}
		}
		
		public GSEnumerable<_LeaderboardEntry_imagedata> First_imagedata{
			get{return new GSEnumerable<_LeaderboardEntry_imagedata>(response.GetObjectList("first"), (data) => { return new _LeaderboardEntry_imagedata(data);});}
		}
		
		public GSEnumerable<_LeaderboardEntry_imagedata> Last_imagedata{
			get{return new GSEnumerable<_LeaderboardEntry_imagedata>(response.GetObjectList("last"), (data) => { return new _LeaderboardEntry_imagedata(data);});}
		}
	}
	
	public class AroundMeLeaderboardResponse_imagedata : AroundMeLeaderboardResponse
	{
		public AroundMeLeaderboardResponse_imagedata(GSData data) : base(data){}
